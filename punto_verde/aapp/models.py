...
class IngresoMaterial(models.Model):
    ...
    receptor_rut_receptor = models.ForeignKey('Receptor', models.DO_NOTHING, db_column='receptor_rut_receptor', blank=True, null=True)
    contenedor_id_contenedor = models.ForeignKey(Contenedor, models.DO_NOTHING, db_column='contenedor_id_contenedor', blank=True, null=True)
    def __int__(self):
